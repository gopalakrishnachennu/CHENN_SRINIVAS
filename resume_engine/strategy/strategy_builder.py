...
def build_strategy(blueprint: JDBlueprint) -> ResumeStrategy:
    """
    Build deterministic JD strategy.

    Wave 3 learning never invents technologies here; it only re-ranks variants
    in `create_variants` when eligible sample count is sufficient.
    """
    ...
    strategy = ResumeStrategy(
        ...
        certification_treatment=blueprint.certification_names(),
        ...
        p4_limits={
            "max_optional_mentions_ratio": thresholds.P4_USAGE_MAX,
